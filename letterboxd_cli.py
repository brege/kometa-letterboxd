...
def build_parser() -> argparse.ArgumentParser:
    ...
    showdown.add_argument("--refresh", action="store_true", help="Refresh showdown dataset JSON")
    showdown.add_argument("--limit", type=int, help="Limit showdown fetch for quick tests")
